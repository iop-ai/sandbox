...
describe("buildPrompt", () => {
	...
	const iopDir = join(testWorkDir, ".iop");
	...
	describe("Boundaries Section", () => {
		it("should include system boundaries at the top of boundaries list", () => {
			...
			expect(result).toContain("- .iop/progress.txt");
			expect(result).toContain("- .iop-worktrees");
		});
...
describe("buildParallelPrompt", () => {
	...
	describe("Boundaries Section", () => {
		...
		it("should include user-defined boundaries after system boundaries", () => {
			...
			writeFileSync(join(iopDir, "config.yaml"), yamlContent);
	...
	describe("Prompt Structure", () => {
		...
		it("should include progress file update instruction", () => {
			const result = buildParallelPrompt({
				task: "Test task",
				progressFile: ".iop/task-progress.txt",
			});

			expect(result).toContain("Update .iop/task-progress.txt with what you did");
		});
